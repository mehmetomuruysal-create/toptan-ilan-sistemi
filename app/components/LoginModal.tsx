  ...
  const modalContent = (
    ...
    >
      <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-6">
        <div 
          className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 sm:p-10 my-8 text-left align-middle transform transition-all animate-in zoom-in-95 duration-200"
          ...
          {view === "login" ? (
            <div className="animate-in slide-in-from-left-4 duration-300">
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <button type="submit" disabled={loading} className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold hover:bg-black transition-all disabled:opacity-50 mt-2">
            ...
            <div className="animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="text-center mt-8">
                <button onClick={() => setView("login")} className="text-sm text-gray-500 hover:text-gray-900 font-medium transition-colors">← Giriş Ekranına Dön</button>
              </div>
            </div>
          )}
        </div>
